...
const { authorization, authorization2, authorization3 } = require("../middleware/authorization")
...
AuthorRouter.post("/add_author", authorValidationMiddleware, authorization3, addAuthor )
